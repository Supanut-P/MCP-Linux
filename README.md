...
The v1.4.2 release is **headless**. It does not require Electron, a desktop
...
The v1.4.2 MCP names, schemas, permission annotations, and compatibility rules
...
```sh
 curl -LO https://github.com/Supanut-P/MCP-Linux/releases/download/v1.4.2/Baitonghub-Linux-mcp-1.4.2-amd64.deb
 curl -LO https://github.com/Supanut-P/MCP-Linux/releases/download/v1.4.2/Baitonghub-Linux-mcp-1.4.2-SHA256SUMS
 sha256sum --check --ignore-missing Baitonghub-Linux-mcp-1.4.2-SHA256SUMS
 sudo apt install ./Baitonghub-Linux-mcp-1.4.2-amd64.deb
```

### Linux x64 tarball

```sh
 curl -LO https://github.com/Supanut-P/MCP-Linux/releases/download/v1.4.2/Baitonghub-Linux-mcp-1.4.2-linux-x64.tar.gz
 tar -xzf Baitonghub-Linux-mcp-1.4.2-linux-x64.tar.gz
```

...
This block is generated from the built `ToolRegistry`. Current count: **217 tools**.
...
| 90 | `workspace_changes` | READ | yes | no |
| 91 | `session_handoff` | READ | yes | no |
| 92 | `verify_incremental` | EXECUTE | no | no |
...
| 136 | `plugin_install` | DANGEROUS | no | yes |
...
| 153 | `service_context` | READ | yes | no |
| 154 | `process_context` | READ | yes | no |
| 155 | `port_context` | READ | yes | no |
...
| 199 | `inspect_pdf` | READ | yes | no |
| 200 | `compare_pdf_pages` | READ | yes | no |
| 201 | `project_profile_get` | READ | yes | no |
| 202 | `project_profile_set` | WRITE | no | no |
| 203 | `handoff_context` | READ | yes | no |
| 204 | `benchmark_run` | EXECUTE | no | no |
| 205 | `regression_report` | READ | yes | no |
| 206 | `lsp_diagnostics` | READ | yes | no |
| 207 | `lsp_rename` | WRITE | no | no |
| 208 | `debug_attach` | EXECUTE | no | no |
| 209 | `debug_step` | EXECUTE | no | no |
| 210 | `git_worktree_spawn` | DANGEROUS | no | yes |
| 211 | `git_worktree_remove` | DANGEROUS | no | yes |
| 212 | `pdf_extract_tables` | READ | yes | no |
| 213 | `self_heal_plan` | READ | yes | no |
| 214 | `self_heal_apply` | DANGEROUS | no | yes |
| 215 | `skills_import` | WRITE | no | no |
| 216 | `agent_swarm_run` | EXECUTE | no | no |
| 217 | `tool_batch` | DANGEROUS | no | yes |

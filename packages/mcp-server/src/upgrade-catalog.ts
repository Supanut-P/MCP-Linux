...
export const UPGRADE_TOOL_CATALOG: readonly UpgradeToolCatalogEntry[] = [
  ...
  read('remote_fleet', 47, 'Inspect a bounded set of explicitly registered SSH hosts with fixed read-only operations.', ['remote', 'fleet', 'linux', 'inspection'], { availability: 'optional', requirements: ['registered remote hosts', 'pinned SSH fingerprints', 'Linux Secret Service'], supportsCancel: true, supportsDryRun: false, auditTarget: 'remote-fleet' }),
